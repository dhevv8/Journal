  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <p className="text-lg font-semibold md:text-xl text-orange-600 mb-8">
          Capture your thoughts, track your mood, and write your heart out, in a
          beautiful and secure space.
        </p>
        <div className="relative">
          <div
            className="absolute inset-0 bg-gradient-to-t from-orange-50 via-transparent
           to-transparent pointer-events-none z-10"
          />
          <div className="bg-white rounded-2xl p-4 max-full mx-auto">
            <div
              className="border-b border-orange-100 pb-4 mb-4 flex items-center
            justify-between"
            >
            ...
            <div>
              ...
              <Skeleton className="h-4 bg-orange-100 rounded w-3/4 mb-3 mt-2" />
              <Skeleton className="h-4 bg-orange-100 rounded w-full mb-3" />
        ...
        <div className="flex flex-row gap-2 justify-center">
          ...
          <Link href="#features">
            <Button
              variant="outline"
              className="px-8 py-6 rounded-full border-orange-600 text-orange-600
              hover:bg-orange-100"
            >
              Learn More
            </Button>
      ...
      <section
        id="features"
        className="mt-24 mx-8 grid md:grid-cols-2 lg:grid-cols-3  gap-8"
      >
        {features.map((feature, index) => (
          <Card key={feature.title} className="shadow-lg">
            <CardContent className="p-6">
              ...
              <h3 className="font-semibold text-xl text-orange-200 mb-2">
                {feature.title}
              </h3>
      ...
      <div className="space-y-24 mt-24 mx-8">
        {/* Feature 1 */}
      ...
      <div className="space-y-4 bg-white rounded-2xl shadow-xl p-6 border border-orange-100">
            {/* Editor Preview */}
            <div className="h-40 bg-gradient-to-t from-orange-50 rounded-lg"></div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-orange-700">
             Track your mood and emotions over time with our analytics dashboard.
            </p>
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-orange-400" />
